================================================================================
    MFC 라이브러리 : tp_fixbuzzer 프로젝트 개요
================================================================================

응용 프로그램 마법사에서 이 tp_fixbuzzer 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 tp_fixbuzzer 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.

tp_fixbuzzer.vcxproj
...
tp_fixbuzzer.h
    ...
    헤더(Resource.h 포함)가 들어 있고 Ctp_fixbuzzerApp 응용 프로그램
    클래스를 선언합니다.

tp_fixbuzzer.cpp
    응용 프로그램 클래스 Ctp_fixbuzzerApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\tp_fixbuzzer.ico
    ...
    주 리소스 파일인 tp_fixbuzzer.rc에 의해 포함됩니다.
...
tp_fixbuzzerDoc.h, tp_fixbuzzerDoc.cpp - 문서
    이 파일에는 Ctp_fixbuzzerDoc 클래스가 들어 있습니다. 이 파일을 편집하여
    특수한 문서 데이터를 추가하고 Ctp_fixbuzzerDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

tp_fixbuzzerView.h, tp_fixbuzzerView.cpp - 문서 뷰
    이 파일에는 Ctp_fixbuzzerView 클래스가 들어 있습니다.
    Ctp_fixbuzzerView 개체는 Ctp_fixbuzzerDoc 개체를 보는 데 사용됩니다.



/////////////////////////////////////////////////////////////////////////////

응용 프로그램 마법사가 OLE 관련 클래스도 만들었습니다.

CntrItem.h, CntrItem.cpp
    이 파일에는 Ctp_fixbuzzerCntrItem 클래스가 들어 있습니다. 이 클래스는 OLE 개체를
    조작하는 데 사용됩니다. OLE 개체는 대개 Ctp_fixbuzzerView
    클래스에 의해 표시되며 Ctp_fixbuzzerDoc 클래스의 일부로 serialize됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 tp_fixbuzzer.pch와
