...
int_t socket(int_t family, int_t type, int_t protocol)
{
   ...
   else
   {
      ...
      socketError(NULL, __ERROR_INVALID_PARAMETER);
      return SOCKET_ERROR;
   }
   ...
   {
      //Report an error
      socketError(NULL, __ERROR_OUT_OF_MEMORY);
      return SOCKET_ERROR;
   }
...
int_t bind(int_t s, const sockaddr *addr, int_t addrlen)
{
   ...
   {
      socketError(NULL, __ERROR_INVALID_SOCKET);
      return SOCKET_ERROR;
   }
   ...
   {
      //Report an error
      socketError(sock, __ERROR_INVALID_PARAMETER);
      return SOCKET_ERROR;
   }
...
int_t getsockname(int_t s, sockaddr *addr, int_t *addrlen)
{
   ...
   {
      socketError(sock, __ERROR_NO_BINDING);
      return SOCKET_ERROR;
   }
...
int_t setsockopt(int_t s, int_t level, int_t optname, const void *optval, int_t optlen)
{
   ...
   if(level == SOL_SOCKET)
   {
      ...
      case SO_RCVTIMEO:
         ...
         {
            socketError(NULL, __ERROR_INVALID_LENGTH);
            return SOCKET_ERROR;
         }
      ...
      default:
         //Report an error
         socketError(NULL, __ERROR_INVALID_OPTION);
         return SOCKET_ERROR;
      }
   }
   //Unknown level
   ...
   {
      //Report an error
      socketError(NULL, __ERROR_INVALID_LEVEL);
      return SOCKET_ERROR;
   }
   ...
   fd_set *exceptfds, const timeval *timeout)
{
   ...
   if(!osCreateEvent(&event))
   {
      ...
      socketError(NULL, __ERROR_OUT_OF_RESOURCES);
      return SOCKET_ERROR;
   }
