...
#include "sample_swi.h"
#include "sample_led.h"
#include "sample_riic_rza1h_rsk_i2c.h"
#include "os_port.h"
...
void lcdPutChar(char_t c)
{
   ...
   else if(lcdLine < 16 && lcdColumn < 21)
   {
      ...
      DisplaySetCursor(lcdColumn, lcdLine);
      DisplayStr(buffer);
...
int_t main(void)
{
   ...
   tcpIpStackSetDriver(interface, &rza1EthDriver);
   tcpIpStackSetPhyDriver(interface, &upd60611PhyDriver);
