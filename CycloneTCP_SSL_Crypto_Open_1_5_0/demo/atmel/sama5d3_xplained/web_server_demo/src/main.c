...
int_t main(void)
{
   ...
   //Set host name
   tcpIpStackSetHostname(interface, "WebServerDemo0");
   //Select the relevant network adapter
   tcpIpStackSetDriver(interface, &sama5d3GigabitEthDriver);
   tcpIpStackSetPhyDriver(interface, &ksz9031PhyDriver);
   ...
   //Set interface name
   tcpIpStackSetInterfaceName(interface, "eth1");
   //Set host name
   tcpIpStackSetHostname(interface, "WebServerDemo1");
   //Select the relevant network adapter
   tcpIpStackSetDriver(interface, &sama5d3EthDriver);
   ...
   task = osCreateTask("Blink", blinkTask, NULL, 500, 3);
